...
SELECT a.an_name, a.an_price, orde.ord_datetime
FROM analysis a
JOIN (SELECT * FROM orders WHERE ord_datetime BETWEEN '2020.02.05' AND '2020.02.12') orde
ON a.an_id = orde.ord_an
ORDER BY orde.ord_datetime;
